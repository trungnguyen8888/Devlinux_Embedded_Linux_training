...
class HTML_Info(Info):
    ...
    def __init__(self):
        ...
        self._html_style_path = str(Path(__file__).resolve().parent.parent.parent.parent)
...
class PDF_Info(Info):
    ...
    def __init__(self):
        ...
        self._pdf_themes_path = str(Path(__file__).resolve().parent.parent.parent.parent)
