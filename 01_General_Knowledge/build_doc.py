...
class HTML_Info(Info):
    ...
    def __init__(self):
        ...
        self._html_style_path = str(Path(__file__).resolve().parent.parent)
...
class PDF_Info(Info):
    ...
    def __init__(self):
        ...
        self._pdf_themes_path = str(Path(__file__).resolve().parent.parent)
...
def check_required_files(
    ...
    """
    - Always check body.adoc in ./doc/ (since output_path = CWD/doc)
    ...
    # body.adoc expected at ./doc/ relative to CWD (since output_path = CWD/doc)
    body_path = Path(common_info.output_path) / common_info.asciidoc_file
    ...
    if (SUCCESS == result["result"]):
        ...
        # For PDF, check the existence of theme.yml
...
def build_html(
    ...
    ensure_output_dir(info.output_path)
    ...
    if (required_files_existed["result"] == SUCCESS):
        args = [
            ...
            f"{info.output_path}/{info.asciidoc_file}"
        ]
